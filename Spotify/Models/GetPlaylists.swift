...
public struct GetPlaylists: Codable {
    ...
    public init(collaborative: Bool, getPlaylistsDescription: String, externalUrls: ExternalUrls, followers: Followers, href: String, id: String, images: [ImageModel], name: String, owner: Owner, primaryColor: String?, getPlaylistsPublic: Bool, snapshotid: String, tracks: GetPlaylistsTracks, type: GetPlaylistsType, uri: String) {
